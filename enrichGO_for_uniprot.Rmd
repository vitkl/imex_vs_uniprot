...
## You can test if any of the protein sets associated with GO terms are enriched in your specific set of proteins (1) compared to the other big set (which includes set 1)
