...
# library(devtools)
# devtools::install_github("vitkl/clusterProfiler")
...
for (r in reviewed) {
  for (i in isoforms) {
    for(n in SPECIES_NAME) {
      ...
      if(file.exists(filename.summary3)) {
        whole_proteome_Uniprot_vs_IntAct_vs_protein.exist = as.data.frame(read.delim(filename.summary3, stringsAsFactors = F, quote = ""))
