---
title: "Comparing datasets by MF"
...
```{r cluster_enrichment_negative, fig.height=3, fig.width=12}
...
```{r cluster_enrichment_positive, fig.height=5, fig.width=12}
...
if(!file.exists("MFBonferroninot_result")){
Bonferroninot_result = cluster_GO_enrich_simplify_plot_bioc(formula = proteins ~ resources,
                                              ...
                                              plot_title = "",
                                              drop_GO_levels = drop_GO_levels_)
save(Bonferroninot_result, file = "MFBonferroninot_result")
}
load("MFBonferroninot_result")
print(Bonferroninot_result$plot)
```

```{r Bonferronicluster_enrichment_positive, fig.height=5, fig.width=12}
if(!file.exists("MFbonferroniresult")){
bonferroniresult = cluster_GO_enrich_simplify_plot_bioc(formula = proteins ~ resources,
                                              ...
                                              plot_title = "",
                                              drop_GO_levels = drop_GO_levels_)
save(bonferroniresult, file = "MFbonferroniresult")
}
load("MFbonferroniresult")
...
if(!file.exists("MFWangnot_result")){
Wangnot_result = cluster_GO_enrich_simplify_plot_bioc(formula = proteins ~ resources,
                                              ...
                                              above_corrected_pval = 0.05,
                                              plot_title = "")
save(Wangnot_result, file = "MFWangnot_result")
}
load("MFWangnot_result")
print(Wangnot_result$plot)
```

```{r Wangcluster_enrichment_positive, fig.height=8, fig.width=16, eval=FALSE}
if(!file.exists("MFWangresult")){
Wangresult = cluster_GO_enrich_simplify_plot_bioc(formula = proteins ~ resources,
                                              ...
                                              above_corrected_pval = 0.05,
                                              plot_title = "")
save(Wangresult, file = "MFWangresult")
}
load("MFWangresult")
