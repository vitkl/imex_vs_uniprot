---
title: "Comparing datasets by all GO"
...
```{r dropGOlevels}
drop_GO_levels_ = NULL
maxSetSize_ = Inf
similarity4simplify = "Wang" # Wang or none or kappa score
ontology_ = "ALL"
```
...
if(!file.exists("GOnot_result")){
GOnot_result = cluster_GO_enrich_simplify_plot_bioc(formula = proteins ~ resources,
                                              ...
                                              simplify_fun = "min",
                                              similarity_calc_method = similarity4simplify,
                                              similarity_cutoff = 0.7,
                                              visualize_result = "dotplot",
                                              above_corrected_pval = 0.05,
                                              plot_title = "")
save(GOnot_result, file = "GOnot_result")
}
load("GOnot_result")
print(GOnot_result$plot)
```
...
if(!file.exists("GOresult")){
GOresult = cluster_GO_enrich_simplify_plot_bioc(formula = proteins ~ resources,
...
if(!file.exists("GOBonferroninot_result")){
GOBonferroninot_result = cluster_GO_enrich_simplify_plot_bioc(formula = proteins ~ resources,
                                              protein_groups.dt = not_combined,
                                              reference_protein_set = swissprot_proteins,
                                              identifier_type = "UNIPROT",
                                              ontology = ontology_,
                                              ...
                                              above_corrected_pval = 0.05,
                                              plot_title = "")
save(GOBonferroninot_result, file = "GOBonferroninot_result")
}
load("GOBonferroninot_result")
print(GOBonferroninot_result$plot)
```

```{r Bonferronicluster_enrichment_positive, fig.height=5, fig.width=14}
if(!file.exists("GObonferroniresult")){
GObonferroniresult = cluster_GO_enrich_simplify_plot_bioc(formula = proteins ~ resources,
                                              protein_groups.dt = combined,
                                              reference_protein_set = swissprot_proteins,
                                              identifier_type = "UNIPROT",
                                              ontology = ontology_,
                                              ...
                                              above_corrected_pval = 0.05,
                                              plot_title = "")
save(GObonferroniresult, file = "GObonferroniresult")
}
load("GObonferroniresult")
print(GObonferroniresult$plot)
```