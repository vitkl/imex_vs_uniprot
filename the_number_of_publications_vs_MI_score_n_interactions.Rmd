---
title: "What is the relationship between the number of interactions or MI score and the number of publications ?"
...
```{r dowlnload_all_IntAct, cache=F, fig.width=8,echo = FALSE}
...
You can notice that lines for different methods are located at different heights, which tells us that different methods identify different number of interactions. Two plots below show what is the distribution of number of interactions (from large/small/both scale studies and interaction detection methods) per protein. 
