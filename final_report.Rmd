...
##====================================================================
      ...
      not_in_IMEx_BP = GO_enrich_simplify_plot_bioc(protein_set = unique(proteome_vs_imex_details_f[whole_proteome_Uniprot == 1 & IMEx == 0,whole_proteome_IDs]),
                                   ...
                                   xlabel = "the fraction of proteins with biological function among proteins with no interactions",
                                   drop_GO_levels = c(1:2,15:20))
...
# keytypes(uniprot)
uniprot2entrezgene = as.data.table(UniProt.ws::select(uniprot, 
...
library(scales)
ggplot(proteome_vs_imex_interaction_details_all[SPECIES_NAME == "Homo sapiens",], aes(y = Mass, x =two_hybrid_vs_AP_MS, fill = two_hybrid_vs_AP_MS)) +
