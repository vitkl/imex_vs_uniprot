...
multiplot(plotlist=list(protein_mass + theme(plot.margin = unit(c(0,0,1,0), "cm")), 
                        protein_publ + theme(legend.position = "none") + theme(plot.margin = unit(c(0,1,0,1), "cm")), 
                        protein_charge + theme(legend.position = "none") + theme(plot.margin = unit(c(0,1,1,1), "cm")), 
                        protein_hydropathy + theme(legend.position = "none") + theme(plot.margin = unit(c(0,1,0,1), "cm"))), cols = 2)
```