...
```{r N_publications_vs_N_interactions_3groups, fig.height=9, fig.width=9, fig.cap= "Figure 8"}
# plotting unique_interactions_per_interactor as a function of the number of publications 
{
...
```
  ...
  The number of interaction ID per protein relates to the number of times interaction was detected.
